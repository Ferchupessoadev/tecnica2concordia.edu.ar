    ...
    <main class="flex flex-col items-between">
        <div class="h-[calc(100vh-70px)]">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-8">
                <h1 class="text-xl md:text-4xl font-bold text-white z-10">E.E.T N° 2 Independencia</h1>
                <p class="text-sm md:text-lg font-bold text-white z-10">Formando mediante talleres prácticos y una fuerte vinculación con el mundo laboral</p>
            </div>
